...
export function TransactionTable({ transactions }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Filters Section */}
      <div className="rounded-lg border border-blue-200/50 bg-gradient-to-r from-blue-50/50 to-transparent p-4 shadow-sm">
      ...
      <div className="rounded-lg border border-blue-200/50 overflow-hidden shadow-sm bg-white">
        <Table>
          <TableHeader className="bg-gradient-to-r from-blue-50 to-transparent">
            <TableRow className="border-blue-200/50 hover:bg-blue-50/50">
              <TableHead className="w-12 text-blue-600 font-semibold">
                <Checkbox
                  checked={
              ...
              <TableHead
                className="cursor-pointer text-right text-blue-600 font-semibold hover:text-blue-700"
                onClick={() => handleSort("amount")}
              >
                <div className="flex items-center justify-end gap-1 hover:gap-2 transition-all">
                  Amount
              ...
              <TableHead className="text-blue-600 font-semibold">Recurring</TableHead>
              <TableHead className="w-12 text-blue-600 font-semibold" />
            </TableRow>
          </TableHeader>
          <TableBody>
            {paginatedTransactions.length === 0 ? (
              ...
              paginatedTransactions.map((transaction) => (
                <TableRow 
                  key={transaction.id}
                  className="border-blue-100/50 hover:bg-blue-50/50 transition-colors"
                >
                  <TableCell>
                    <Checkbox
                  ...
                  <TableCell>
                    {transaction.isRecurring ? (
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger>
                            <Badge
                              variant="secondary"
                              className="gap-1 bg-blue-100 text-blue-700 hover:bg-blue-200 border-0 shadow-sm"
                            >
                      ...
                      <Badge variant="outline" className="gap-1 border-blue-200 text-blue-600 bg-blue-50">
      ...
      {/* Pagination */}
      {totalPages > 1 && (
        <div className="flex items-center justify-center gap-3 mt-6 pt-4 border-t border-blue-200/50">
          <Button
            variant="outline"
            size="icon"
